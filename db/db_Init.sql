...
/*
CREATE TABLE IF NOT EXISTS  oyo_source.`source_hotel` (
  `hotel_id` int(10) NOT NULL,
  `hotel_name` varchar(200) NOT NULL
);
insert into oyo_source.`source_hotel`
(`hotel_id`, `hotel_name`)
values
(1,'rujia'),
(2,'qitian');
...
/*
CREATE TABLE IF NOT EXISTS  oyo_source.`source_user` (
  `user_id` int(10) NOT NULL,
  `user_name` varchar(200) NOT NULL,
  `addr` varchar(200) NOT NULL
);
INSERT INTO oyo_source.source_user
...
WHERE table_name = 'source_user'
  AND table_schema = 'oyo_source'
/*
CREATE table  oyo_dw.demo1 (id int,foo STRING, bar STRING);
INSERT OVERWRITE TABLE oyo_dw.demo1 
...
*/
SHOW COLUMNS FROM oyo_dw.demo1